...
var methods = []Method{
	{
		...
		Params: []Param{
			...
			{Key: "NGROK_URL", Prompt: "ngrok static domain", Help: "e.g. your-name.ngrok-free.app (no https://)"},
		},
	},
	{
		ID:          "cloudflare",
		...
		Params: []Param{
			...
			{Key: "WEBHOOK_EXTERNAL_URL", Prompt: "public webhook URL", Help: "the https:// hostname routed to this tunnel"},
		},
	},
	{
		ID:          "tailscale",
		...
		Params: []Param{
			...
			{Key: "WEBHOOK_EXTERNAL_URL", Prompt: "public webhook URL", Help: "https://<hostname>.<tailnet>.ts.net"},
		},
	},
	{
		ID:          "custom",
		...
		Params: []Param{
			{Key: "WEBHOOK_EXTERNAL_URL", Prompt: "public webhook URL", Help: "the https:// URL your webhook is already reachable at"},
		},
	},
}
